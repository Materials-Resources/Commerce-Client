...
const offers = [
  { name: 'Save even more', description: 'Our customers who order more receive special pricing.', href: '#' },
                  ...
                  <div className="max-w-2xl mx-auto py-24 lg:py-64 lg:max-w-none ">
                    <div className="lg:pr-16 lg:text-calm-blue">
                      ...
                      <div className="mt-6">
                        <a
                            href="#"
                            className="inline-block bg-safety-red border border-transparent py-3 px-8 rounded-md font-medium text-white hover:bg-indigo-700"
                        >
                          Shop Our Catalog
                        </a>
                      </div>
