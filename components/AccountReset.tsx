        ...
        <Dialog as="div" className="relative z-10" onClose={setOpen}>
          ...
          <div className="fixed inset-0 z-10 overflow-y-auto">
            <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
              ...
              >
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left text-black shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
                  <div>
                    <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-raisin-black">
                      <KeyIcon
                        className="text-laurel h-6 w-6"
                        aria-hidden="true"
                      />
                    </div>
                    <div className="mt-3 text-center sm:mt-5">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Enter your email here to receive a password reset
                          email.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="mt-5 sm:mt-6">
                    <form onSubmit={processPasswordReset}>
                      <input
                        ...
                        value={resetEmail}
                        className={
                          "focus:ring-laurel my-5 w-full rounded-md border-2 border-raisin-black p-2 text-center"
                        }
                      />
                      <button
                        type="submit"
